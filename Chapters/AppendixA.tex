...
%I = \Int{\exp{-\varphi^{2}}}{\varphi,-\infty,+\infty} = \sqrt{\pi}  \; .
...
%\Int{\Int{\exp{-\left(\varphi^{2} + \psi^{2}\right)}}{\varphi, -\infty, +\infty}}{\psi,
%-\infty, +\infty}
\end{dmath*}.
...
%   \Int{ \exp{-\frac{1}{2}az_{1}^{2}(\varphi)} \D{z_{1}(\varphi)}{\varphi}}{\varphi, -\lambda, \lambda} =  
...
\begin{dmath*}[compact]%[label={int gamma2},compact]
 ...
 %  \Int{\exp{-\frac{1}{2}az_{2}^{2}(\varphi)
...
\begin{dmath*}[compact]%[label={int gamma1},compact]
  ...
  % \Int{ \exp{-\frac{1}{2}az_{3}^{2}(\varphi)} \D{z_{3}(\varphi)}{\varphi}}{\varphi, -\lambda, \lambda} =  
...
%$\oInt{\exp{-\frac{1}{2}az^{2}}}{z,\gamma}=0$, we get
%\begin{dmath*}
%   \sqrt{\frac{2\pi}{a}} 
%   -\exp{\frac{\omega^{2}}{2a}}
%   \Int{\exp{-\frac{1}{2}a\varphi^{2} - i\omega \varphi }

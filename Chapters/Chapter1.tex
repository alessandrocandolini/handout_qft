...
\lettrine{T}{he} \emph{operator} formulation of non-relativistic quantum
...
Ad \cref{item:evolution:H}.  \graffito{How to write down the Hamiltonian of a
   quantum system; quantization} Strictly speaking, $\hat{H}$ should be
...
\begin{remark}
   ...
   %Quantization and de-quantization lead to interesting but
   %unresolved questions; for example, what does classical mechanics can teach
...
\end{dmath}
\section{Path integral treatment of harmonic potential}
\begin{advanced}
